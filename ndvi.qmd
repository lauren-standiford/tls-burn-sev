...
ndvi <- read_csv("E:/ndvi/Landsat_NDVI_Extraction_3years.csv") |>
...
p <- ggplot(ndvi_summary, aes(x = date, y = NDVI, color = LF_FOREST, group = LF_FOREST)) +
	...
	labs(
		...
		y = "NDVI",
		color = "LF_FOREST",
		title = "NDVI from 3 years pre-Tubbs ignition to 3 years post-Tubbs containment",
	) +
	theme_minimal()

p

ggsave(p, filename = "E:/ndvi/ndvi_plot3years2.png", width = 8, height = 8, dpi = 300)
